...
//        $row = 5;
        ...
        foreach ($lswdo_details as $lswdodata):
            ...
            $baselinescore = $lswdodata->baseline_score;
            $leveloffunction = $lswdodata->level_function_baseline;
...
// Rename worksheet (worksheet, not filename)
        $objPHPExcel->getActiveSheet()->setTitle('LSWDO-Baseline');
...
// Rename worksheet (worksheet, not filename)
        $objPHPExcel->getActiveSheet()->setTitle('LSWDO-Updated');
...
//        $row = 5;
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('C4', 'City');
        $objPHPExcel->getActiveSheet()->getColumnDimension('C')->setAutoSize(true);
        $objPHPExcel->getActiveSheet()->getStyle('C4')->getAlignment()->applyFromArray(
            array('horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_CENTER,));
...
//        $row = 5;
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('C4', 'Municipality');
        $objPHPExcel->getActiveSheet()->getColumnDimension('C')->setAutoSize(true);
        $objPHPExcel->getActiveSheet()->getStyle('C4')->getAlignment()->applyFromArray(
            array('horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_CENTER,));
