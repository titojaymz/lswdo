...
<div class="content">
    <div class="page-header">
        <h1 class="title">Visit Count List</h1>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <a class="btn btn-sm btn-primary"  href="<?php echo base_url('lib_visitCount/vcadd/') ?>"><i class="fa fa-plus"></i>Add New Visit Count</a><br><br>
                    <div class="panel-body table-responsive">
                        ...
                        <table class="table display table-bordered table-striped table-hover" id="example0">
                            ...
                            <tbody>
                            <?php foreach($countList as $row): ?>
                                <tr>
                                    <td><a href="<?php echo base_url('lib_visitCount/vcedit/'.$row->visit_id.'') ?>" class = 'btn btn-sm btn-success'>Edit</a> </td>
