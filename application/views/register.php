...
<div class="login-form">
    <form method="post">
        ...
        <div class="form-area">
            ...
            <div class="group">
                <input type="text" class="form-control" placeholder="Position Name" name="position" required autofocus>
                <i class="fa fa-user"></i>
            </div><div class="group">
                <input type="text" class="form-control" placeholder="Designation" name="designation" required autofocus>
                <i class="fa fa-user"></i>
            </div>
            <div class="group">
            ...
            <div class="group">
                <input type="contactno" class="form-control" placeholder="Contact No" name="contactno" required>
                <i class="fa fa-envelope-o"></i>
            </div>
