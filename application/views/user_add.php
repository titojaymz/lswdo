            ...
            <fieldset>
                ...
                <div class="form-group form-group-sm">
                    <div class="row colbox">
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <input id="full_name" name="full_name" placeholder="Full name" type="text" class="form-control"  value="<?php echo set_value('full_name'); ?>" required autofocus/>
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <input id="pword" name="pword" placeholder="Password" type="password" class="form-control"  value="<?php echo set_value('pword'); ?>" required/>
