                    ...
                    <table style="width:100%">
                        ...
                        <tr>
                            <td width="50%">
                                ...
                                <input class="form-control" type="tel" minlength="7" maxlength="19" pattern="[a-zA-Z0-9]+" tabindex="8" name="contact_no" value="<?php echo set_value('contact_no') ?>" style="width:90%;" placeholder="Contact Number" required>
                                </div>
                            </td>
