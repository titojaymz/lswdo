            ...
            <div class="panel panel-default">
                ...
                <div class = "panel-body" style="display: block;">
                    ...
                    <?php if($countLS > 0){ ?>
                        <table width = "100%">
                            <tr>
                                <td align= "left" width = "50%"><a class="btn btn-m btn-option5" href="<?php echo base_url('indicator/indicatorViewpart3/'.$profileID.'/'.$refID) ?>"><i class="fa fa-caret-square-o-down"></i>Back to <b>III. CASE MANAGEMENT</b></a></td>
                                <td align= "right" width = "50%"><a class="btn btn-m btn-option5" href="<?php echo base_url('psb_riders/psb_rider_add/'.$profileID.'/'.$refID) ?>"><i class="fa fa-caret-square-o-down"></i>Proceed To <b>PSB Rider Questions</b></a></td>
                            </tr>
                        </table>
<br/>
