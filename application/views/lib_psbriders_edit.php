                    ...
                    <div class="panel-body table-responsive">
                        ...
                        <table class="table display table-bordered table-striped table-hover">
                                ...
                                <td>
                                    <select id="mainCat" name = "mainCat" class = "form-control-radius" style="width: 500px">
                                        ...
                                        <?php foreach($psbMain as $mainCat): ?>
                                            <option value = "<?php echo $mainCat->psbrider_main_category_id; ?>"
                                            <?php
                                                if($mainCat->psbrider_main_category_id == $psbSub->psbrider_main_category_id){
                                                    echo "selected";
                                                }
                                            ?>
                                            ><?php echo $mainCat->psbrider_main_category_title ?></option>
                                        <?php endforeach ?>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type = "text" id="subCategory" name = "subCategory" class = "form-control-radius" style="width: 500px" value = "<?php echo $psbSub->psbrider_sub_category_title ?>">
                                </td>
