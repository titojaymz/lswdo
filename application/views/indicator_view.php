        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class = "panel-body" style="display: block;">
                    ...
                    <?php if($countLS > 0){ ?>
                    <a class="btn btn-m btn-option5" href="<?php echo base_url('indicator/indicatorViewpart2/'.$profileID) ?>"><i class="fa fa-caret-square-o-down"></i>Proceed to <b>II. PROGRAM MANAGEMENT</b></a><br><br>
