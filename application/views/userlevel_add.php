                ...
                <div class="panel-body">
                    ...
                    <table class="table display table-bordered table-striped table-hover">
                        <tr>
                            ...
                            <td>
                                <input id="userlevel_id" name="userlevel_id" placeholder="User Level ID" type="text" class="form-control"  value="<?php echo set_value('userlevel_id'); ?>" required autofocus/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="userlevel_name" name="userlevel_name" placeholder="User Level Name" type="text" class="form-control"  value="<?php echo set_value('userlevel_name'); ?>" required autofocus/>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea id="userlevel_desc" name="userlevel_desc" placeholder="Description" class="form-control" autofocus></textarea>
